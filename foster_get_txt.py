"""
This example file fetches a text file of William Wordsworth's poems from the web 
...
def main():
    ...
    """
    txt_url = 'https://www.gutenberg.org/cache/epub/8905/pg8905.txt'
    logger.info("Starting text fetch demonstration...")
    fetch_txt_file(fetched_folder_name, "pg8905.txt", txt_url)
